...
public class Beginnings {
    ...
    public static void main(String[] args) {
        ...
        new Matrix(VectorType.ROW, dats[10]).print();
        System.out.println("RESULTS");
        network.process(dats[10]).print();
        System.out.println("TARGETS");
        new Matrix(VectorType.ROW, targets[10]).print();
        ...
        new Matrix(VectorType.ROW, test).print();
        System.out.println("Test Results:");
        network.process(test).print();
        
        /*final Matrix rowMaj = new Matrix(VectorType.ROW, dat);
        rowMaj.print();
        System.out.println(rowMaj.instance(0));
        final Matrix colMaj = new Matrix(VectorType.COLUMN, dat);
        colMaj.print();
        ...
        final Matrix rowMaj2 = new Matrix(VectorType.ROW, dat2);
        final Matrix colMaj2 = new Matrix(VectorType.COLUMN, dat3);
        
        final Matrix rowMaj3 = new Matrix(VectorType.ROW, 8, 4);
        final Matrix colMaj3 = new Matrix(VectorType.COLUMN, 4, 8);
